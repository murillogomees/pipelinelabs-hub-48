...
-- Create has_specific_permission function with proper search path
...
-- Critical Security Fix 2: Remove foreign tables from API access
-- These tables should not be accessible via API due to RLS bypass
