...
BEGIN
  ...
  -- Se encontrou plano e empresa, criar subscription com trial de 30 dias
  IF basic_plan_id IS NOT NULL AND user_company_id IS NOT NULL THEN
    ...
    ON CONFLICT (company_id) DO NOTHING; -- Evita duplicatas
  END IF;
...
-- Garantir que existe um plano básico
